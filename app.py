...
from utils import *
from logs import log_response, init_db
...
@st.cache_resource
def init_db_once():
    """Cache the database to avoid re-runs after every UI reload"""
    init_db()
    return True
...
home_tab, response_tab = st.tabs(["Home", "Response"])
